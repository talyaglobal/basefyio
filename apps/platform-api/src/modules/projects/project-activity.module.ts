...
@Module({ imports: [PrismaModule], providers: [ProjectActivityService, RealtimeEventsService, RealtimeStreamService], exports: [ProjectActivityService, RealtimeEventsService] })
