...
export const api = {
  ...
  billing: {
    ...
    managementEmailReports() {
      return request<any>('/billing/management/email-reports');
    },
    updateManagementEmailReports(body: { schedule?: Record<string, boolean>; content?: Record<string, boolean> }) {
      return request<any>('/billing/management/email-reports', {
        method: 'PATCH',
        body: JSON.stringify(body),
      });
