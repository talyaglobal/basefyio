...
function TimelineBackground() {
  return (
    ...
    >
      <defs>
        <pattern id="tl-grid-pub" width="60" height="60" patternUnits="userSpaceOnUse">
          <circle cx="30" cy="30" r="1.5" fill="currentColor" />
        </pattern>
        <pattern id="tl-db-pub" width="240" height="200" patternUnits="userSpaceOnUse">
          <rect width="240" height="200" fill="url(#tl-grid-pub)" />
      ...
      <rect width="100%" height="100%" fill="url(#tl-db-pub)" />
    </svg>
  );
}
    ...
    <main className="relative mx-auto w-full max-w-4xl px-6 py-12">
      ...
      <div className="relative">
        ...
        <p className="mb-10 text-sm text-muted-foreground">
          Latest updates, new features, and improvements to Kolaybase.
        </p>
