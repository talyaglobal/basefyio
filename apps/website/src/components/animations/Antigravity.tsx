 ...
 *
 * A WebGL-based particle animation using Three.js and @react-three/fiber.
 * Features magnetic attraction, wave motion, and interactive mouse tracking.
 */
...
const AntigravityInner = ({
  ...
  useFrame((state) => {
    ...
    particles.forEach((particle, i) => {
      ...
      const finalScale = scaleFactor * (0.8 + Math.sin(t * pulseSpeed) * 0.2 * particleVariance);
 ...
 *
 * Renders a 3D particle animation with magnetic attraction effects.
 */
